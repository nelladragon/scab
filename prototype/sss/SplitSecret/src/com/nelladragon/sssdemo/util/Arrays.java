/* $Id: Arrays.java,v 1.3 2012/06/26 03:50:17 scottc4 Exp $ */
/*
...
public class Arrays {
     ...
     * @return <code>true</code> if byte arrays are equal.
     */
    public static boolean equals(final byte[] a, final int aOffset, int aLen, final byte[] b, final int bOffset,
            final int bLen) {
     ...
     * @param clearData If <code>true</code> then clear sensitive data for <code>data</code> in this method.
    ...
    public static byte[] addData(byte[] data, byte[] in, int offset, int len, boolean clearData) {
        ...
        if (data == null) {
            ...
            if (clearData) {
//TODO                ClearSensitiveData.array(data);
            }
        }
        return returnValue;
    }
