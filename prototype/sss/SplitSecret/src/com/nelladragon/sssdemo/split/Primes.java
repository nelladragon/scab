...
/**
 * Well known primes which should be assumed to be good.
 *
 * These primes were taken from Crypto-J 6.1.2's SSS.bin.src file.
 *
 *
 */
public class Primes {
...
//    public static final BigInteger P1024 = new BigInteger(P1024S, 16);
    ...
    public static final BigInteger PRIME = P256;
